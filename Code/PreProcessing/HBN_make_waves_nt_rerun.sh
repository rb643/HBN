...
anatdir=${topdir}/BIDS2/${sub}-${site}/anat/
procdir=${topdir}/BIDS2/${sub}-${site}/xtmp/
procfunc=${topdir}/BIDS2/${sub}-${site}/proc_func/
qcfunc=${topdir}/BIDS2/${sub}-${site}/proc_func/qc
surfacedir=${topdir}/BIDS2/${sub}-${site}/surfaces/${sub}
...
cd ${procdir}/
# run wavelet code
python /home/rb643/matlab/fmri_spt/speedyppX_reg.py -d ${sub}_task-rest_bold.nii.gz -a ${sub}_brain.nii.gz -o --wds --SP --EDOF --rmot --rmotd --rcsf --nobandpass --zeropad=100 --ss=MNI152 --qwarp --csftemp=MNI152 --csfpeel=6 --tpattern=${tpatt} --OVERWRITE
